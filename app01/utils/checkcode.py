...
# font_file路径必须为绝对路径
def check_code(width=120, height=30, char_length=4, font_file=r"F:\My_Study\1.Python_learning\8.Django_Learning\Django_Stdy02_EMS\app01\utils\monaco.ttf", font_size=28):
    code = []
